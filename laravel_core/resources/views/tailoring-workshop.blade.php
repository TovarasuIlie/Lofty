...
<link href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@1&family=Playfair+Display:ital@1&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
	...
	<title>Atelier De Croitorie Pentru Copii - Lofty by Flory Cucu</title>
</head>
<body>
	      ...
	      <ul class="navbar-nav">
	        ...
	        <li class="nav-item dropdown">
	          ...
	          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
	            ...
	            <li><a class="dropdown-item active" aria-current="page" href="/atelier-croitorie-copii">Atelier de Croitorie pentru Copii</a></li>
	          </ul>
	        </li>
<!-- 	        <li class="nav-item">
	...
	<div class="wrapper">
		...
		<div id="content">
			<div class="container">
				...
				<p>La <b>Lofty</b>, ne dedicăm să îi învățăm pe cei mici arta și bucuria croitoriei într-un mediu creativ și distractiv. Cu ateliere adaptate special pentru copii, îi încurajăm să își exploreze imaginația și să își dezvolte abilitățile practice, descoperind minunata lume a modei și a cusutului.</p>
				<p><b>Ce oferim:</b></p>
				<ul>
					<li><b>Experiențe interactive</b>: În cadrul atelierelor noastre, copiii sunt invitați să experimenteze diferite tipuri de țesături, culori vibrante și accesorii distractive, sub îndrumarea noastră atentă și expertă.</li>
					<li><b>Învățare prin joacă</b>: Prin activități și proiecte adaptate vârstei lor, copiii vor învăța fundamentalele croitoriei și vor dezvolta abilități practice precum tăierea, cusutul și decorarea.</li>
					<li><b>Creație și exprimare</b>: Încurajăm fiecare copil să își exprime creativitatea și să își pună în practică ideile, oferindu-le libertatea de a crea propriile lor piese vestimentare sau accesorii.</li>
					<li><b>Interacțiune și colaborare</b>: Prin colaborarea și interacțiunea cu ceilalți copii, micuții noștri participanți vor avea oportunitatea să își împărtășească ideile, să se inspire reciproc și să își dezvolte abilitățile sociale.</li>
					<li><b>Flexibilitate în locație</b>: Atelierele noastre se pot desfășura atât în locația noastră, unde punem la dispoziție un mediu sigur și inspirant, cât și în locații propuse de clienți, pentru a ne adapta nevoilor și preferințelor fiecăruia.</li>
				</ul>
				<p>La <b>Lofty</b>, ne pasă să oferim copiilor o experiență memorabilă și educativă în lumea croitoriei, unde să își dezvolte creativitatea și să își facă noi prieteni într-un mediu plin de bucurie și învățare.</p>
			</div>
