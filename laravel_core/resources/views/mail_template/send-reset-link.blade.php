            ...
            <tr>
              <td class="wrapper"
                ...
                <p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                  Acest email ti-a fost trimis, deoarece ai solititat ca doresti sa iti schimbi parola de la contul cu numele <b>{{ $content['name'] }}</b>.
                  Pentru a continua procesul, apasa pe butonul de mai jos:</p>
                            ...
                            <tr>
                              <td
                                ...
                                valign="top" align="center" bgcolor="#0867ec"> <a href="{{$content['link']}}"
                                  target="_blank"
                                  style="border: solid 2px #000000; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; background-color: #000000; border-color: #000000; color: #ffffff;">Reseteaza-ti parola!</a></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td class="content-block"
                  ...
                  <span class="apple-link" style="color: #9a9ea6; font-size: 16px; text-align: center;">Str. Vlad Dracul
                    nr. 1, bloc B13, parter, Bucureşti Sectorul 3, Romania</span>
                </td>
              </tr>
              <tr>
                <td class="content-block powered-by"
                  style="font-family: Helvetica, sans-serif; vertical-align: top; color: #9a9ea6; font-size: 16px; text-align: center;"
                  valign="top" align="center">
                  Copyright. All Rights Reseved | by <a href="https://www.instagram.com/niculai_ilie/"
                    style="color: #9a9ea6; font-size: 16px; text-align: center; text-decoration: none;">Niculai
                    Ilie-Traian</a>
                </td>
              </tr>
            </table>
