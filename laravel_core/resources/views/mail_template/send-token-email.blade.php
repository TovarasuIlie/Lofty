              ...
              <td class="wrapper"
                ...
                <p
                  ...
                  Mai jos ai primit un link de acces de la administratorii <b>Lofty by Flory Cucu</b> pentru ati crea un cont. Ai <b>10
                    minute</b> la dispozitie sa accesezi link-ul. Acest link poate fi accesata <b>o singura data</b>, dupa accesare, nemaifiind valabil.</p>
                            ...
                            <tr>
                              <td
                                ...
                                valign="top" align="center" bgcolor="#0867ec"> <a href="{{$content['link']}}"
                                  target="_blank"
                                  style="border: solid 2px #000000; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: #000000; border-color: #000000; color: #ffffff;">Inregistreaza
                                  acuma!</a></td>
                            </tr>
                          </tbody>
                        </table>
