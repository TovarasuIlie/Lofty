...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@1&family=Playfair+Display:ital@1&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap"
        rel="stylesheet">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/dashboard/conturi/gestionare-cont/deleteUser/{{ $user->id }}" class="btn btn-danger">Sterge cont!</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex flex-column gap-3">
                    <a href="/dashboard/conturi/gestionare-cont/makeClient/{{ $user->id }}" class="btn btn-sm btn-secondary">Promoveaza la Admin</a>
                    <a href="/dashboard/conturi/gestionare-cont/makeAdmin/{{ $user->id }}" class="btn btn-sm btn-success">Promoveaza la Admin</a>
                    <a href="/dashboard/conturi/gestionare-cont/makeManager/{{ $user->id }}" class="btn btn-sm btn-danger">Promoveaza la Manager</a>
                </div>
                <div class="modal-footer">
                            ...
                            <div class="col">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-center gap-3">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#promote-modal">Promoveaza</button>
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#delete-modal">Sterge Cont</button>
                                    </div>
                                </div>
                            </div>
                        </div>
