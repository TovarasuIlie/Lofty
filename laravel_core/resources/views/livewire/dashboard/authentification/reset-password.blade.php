        ...
        <div class="d-flex justify-content-center vh-100 align-items-center">
            <div class="card shadow p-3 mb-5 bg-body rounded">
                <div class="card-body p-4">
                    ...
                    <h5 class="mb-3 text-center">Resetare Parola Cont</h5>
                    <form wire:submit="resetPassword">
                        ...
                        <div class="form-floating mb-3"  style="max-width: 330px;">
                            ...
                            @error('confirmPassword') <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {!! $message !!}</span> @enderror
                        </div>
                        @if(session('failed'))
                        ...
                        <button wire.loading.class="disabled" type="submit" class="btn btn-outline-black p-3 w-100 fw-bold">
                            <div wire:loading.remove>
                                <i class="fas fa-screwdriver"></i> Reseteaza!
                            </div>
