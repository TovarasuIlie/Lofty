...
<head>
	...
	<title>Despre Noi - Lofty by Flory Cucu</title>
</head>
<body>
	...
	<div class="wrapper">
		...
		<div id="content">
			<div class="container" style="font-size: 20px; padding: 50px 0 50px 0;">
				...
				<p style="text-indent: 30px;">Bine ai venit la <b>Lofty</b> - locul unde moda devine o expresie personalizată a individualității tale! Suntem un brand pasionat și dedicat, specializat în producția de haine la comandă, create cu atenție la detalii și ajustate perfect pe măsurile tale exacte. Cu o abordare unică, punem accent pe evidentierea personalitatii clienților noștri, transformând viziunile și preferințele lor în piese vestimentare care spun povestea autentică a fiecăruia.</p>	
				<p style="text-indent: 30px;">Fie că îți dorești o rochie de seară elegantă, un costum de afaceri impecabil sau o piesă vestimentară casual, Lofty are grijă de toate nevoile tale. Gama noastră diversificată de articole "ready to wear", cu eticheta <b>LOFTY</b>, este perfectă pentru a completa garderoba ta cu piese cu design unicat, create din materiale de cea mai înaltă calitate și menite să fie atât versatile, cât și mereu în trend.</p>
				<p style="text-indent: 30px;">În plus, suntem mândri să oferim servicii complete de croitorie, design vestimentar și consultanță, pentru a aduce visul tău vestimentar la viață. Colaborăm cu studenți de la <b>UNARTE</b> și cu cei care își doresc să își creeze propriul brand de modă, oferindu-le sprijinul și expertiza necesară pentru a-și îndeplini visele.</p>
				<p style="text-indent: 30px;">La <b>Lofty</b>, credem că fiecare individ are o poveste unică de spus prin modă, iar echipa noastră pasionată este aici pentru a te ajuta să-ți exprimi creativitatea și personalitatea prin haine. Descoperă o experiență de shopping personalizată și unicitatea fiecărei creații Lofty!</p>
			</div>
