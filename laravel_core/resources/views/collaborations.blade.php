...
<head>
	...
	<title>Colaboranti - Lofty by Flory Cucu</title>
</head>
<body>
...
<!-- 	        <li class="nav-item">
	        ...
	        <li class="nav-item">
	          <a class="nav-link active" aria-current="page" href="/colaboranti">Colaboranti</a>
	        </li>
	        <li class="nav-item">
	...
	<div class="wrapper">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-uppercase" style="margin-bottom: 50px;">Colaboratori <b>Lofty</b></h1>
			</div>
